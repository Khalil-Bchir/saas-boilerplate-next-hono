...
import { ArrowRight, Code2, ExternalLink, Github, Globe, KeyRound, Layers, Linkedin, Loader2, Mail, Monitor, Moon, Shield, ShieldCheck, Star, Sun, Terminal, User, Workflow, Zap } from "lucide-react"
...
export function HomePageContent() {
  ...
  const handleSubmitReview = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setReviews((prev) => [created, ...prev].slice(0, 12))
  ...
  return (
    <div className="min-h-screen bg-background">
      <section className="relative py-20 lg:py-40 overflow-hidden border-b border-primary/10">
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
              <Button size="lg" className="gap-2 px-8 h-12 font-semibold bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all" asChild>
                <Link href="/auth/login">
                  {strings.nav_login}
                  <ArrowRight className="h-4 w-4" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="gap-2 px-8 h-12 font-semibold border-primary/50 hover:bg-primary/10 transition-all" asChild>
                <Link href="/auth/sign-up">{strings.nav_get_started}</Link>
              </Button>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 justify-center pt-4">
              <Button variant="ghost" className="gap-2 text-muted-foreground hover:text-primary transition-colors" asChild>
                <Link href="/docs">
                  {strings.nav_docs}
                  <ArrowRight className="h-4 w-4" />
                </Link>
      ...
      <section id="use-cases" className="py-20 lg:py-32 scroll-mt-24 border-b border-primary/10">
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl space-y-12">
          ...
          <Card className="border border-border/60 bg-card/30 backdrop-blur-sm">
            ...
            <CardContent>
              <Tabs defaultValue="use-cases" className="gap-6">
                <TabsList className="w-full justify-start border-b bg-transparent p-0">
                  <TabsTrigger value="use-cases" className="gap-2 rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent">
                    <Layers className="h-4 w-4" />
                    Use cases
                  </TabsTrigger>
                  <TabsTrigger value="benefits" className="gap-2 rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent">
                    <ShieldCheck className="h-4 w-4" />
                    Benefits
                  </TabsTrigger>
                  <TabsTrigger value="deployment" className="gap-2 rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent">
